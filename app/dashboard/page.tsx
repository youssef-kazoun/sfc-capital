...
import { Star, Briefcase, Bell, ArrowRight } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-8">
        <StatCard icon={Star} label="Watchlist" value={watchlistCount.c} href="/dashboard/watchlist" />
        <StatCard icon={Briefcase} label="Portfolio positions" value={portfolioCount.c} href="/dashboard/portfolio" />
        <StatCard icon={Bell} label="Active alerts" value={alertsCount.c} href="/dashboard/alerts" />
      </div>
      ...
      <Card>
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="font-display text-lg text-ink">{subscription?.name || "Starter (Free)"}</div>
          </div>
