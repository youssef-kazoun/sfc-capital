  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16">
      ...
      <p className="text-ink/80 leading-relaxed mt-6">
        ...
        إدارة المحفظة العملية للمستثمرين في السوق السعودي (تاسي) والأسواق
        الأمريكية. يقوم فريقنا من المحللين بنشر توصيات بمستويات دخول وهدف
        ووقف خسارة واضحة، مع الأسباب الكاملة وراء كل توصية.
      </p>
