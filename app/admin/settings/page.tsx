...
const KNOWN_KEYS = [
  { key: "site_name", label: "Site name", placeholder: "SFC Capital" },
  { key: "support_email", label: "Support email", placeholder: "support@sfccapital.com" },
  { key: "support_phone", label: "Support phone", placeholder: "+20 100 000 0000" },
      ...
      <Card className="max-w-lg space-y-4">
        {KNOWN_KEYS.map((k) => (
          <div key={k.key} className="flex items-end gap-2">
            ...
            <Button variant="secondary" onClick={() => saveKey(k.key)}>Save</Button>
          </div>
        ))}
